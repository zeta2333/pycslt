<template>
    <div class="tools-div">
        ...
        <el-table :data="list" style="width: 100%; margin-bottom: 20px" row-key="id" border default-collapse-all>
...
import { FindNodes, SaveMenu, UpdateSysMenuById, RemoveSysMenuById } from '@/api/system/sysMenu'
