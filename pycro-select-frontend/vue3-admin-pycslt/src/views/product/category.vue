        ...
        <el-dialog v-model="dialogImportVisible" title="导入" width="30%">
            <el-form label-width="120px">
                <el-form-item label="分类文件">
                    <el-upload class="upload-demo" action="http://localhost:6815/admin/product/category/import"
...
import { FindCategoryByParentId, ExportCategoryData } from '@/api/product/category.js'
