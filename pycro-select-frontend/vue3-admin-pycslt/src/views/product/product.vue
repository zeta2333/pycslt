                ...
                <el-collapse v-model="activeNames">
                    <el-collapse-item title="商品基本信息" name="productBaseInfo">
                        ...
                        <el-form-item label="轮播图">
                            <el-upload v-model:file-list="fileList" action="http://localhost:6815/admin/system/fileUpload"
                            ...
                            <el-table :data="product.productSkuList" border style="width: 100%">
                                ...
                                <el-table-column label="图片" #default="scope" width="80">
                                    <el-upload class="avatar-uploader"
                                        action="http://localhost:6815/admin/system/fileUpload" :show-file-list="false"
                    ...
                    <el-collapse-item title="商品详情信息" name="productDetails">
                        <el-form-item label="详情图片">
                            <el-upload v-model:file-list="detailsFileList"
                                action="http://localhost:6815/admin/system/fileUpload" list-type="picture-card" multiple
...
import { GetProductPageList, SaveProduct, UpdateProductById, GetProductById, DeleteProductById, UpdateProductStatus, UpdateProductAuditStatus } from '@/api/product/product.js'
...
const saveData = async () => {
    console.log("product.value.brandId=", product.value.brandId)
